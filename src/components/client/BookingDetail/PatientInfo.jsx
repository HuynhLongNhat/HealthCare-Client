...
import Prescription from "./Prescription/Prescription/MedicalExaminationResults";
      ...
      <TabsContent value="info" className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-6">
            <div
              className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium flex items-center">
                    ...
                    {moment(booking.patientData.dob).format("DD/MM/YYYY") ||
                      "Không có thông tin"}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium flex items-center">
                    ...
                    {formatPhoneNumber(
                      booking.patientData.phone_number || "Không có thông tin"
                    )}
                  </p>
                </div>
